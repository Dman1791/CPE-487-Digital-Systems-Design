...
set_property -dict { PACKAGE_PIN T8 IOSTANDARD LVCMOS33 } [get_ports { switch8 }];
set_property -dict { PACKAGE_PIN U8 IOSTANDARD LVCMOS33 } [get_ports { switch9 }];
set_property -dict { PACKAGE_PIN R16 IOSTANDARD LVCMOS33 } [get_ports { switch10 }];